<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/users.Master" AutoEventWireup="true" CodeBehind="KategoriGuncelleDetay.aspx.cs" Inherits="WebSatisOtomasyonu.UserPage.KategoriGuncelleDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="baslik">
        <strong>KATEGORİ GÜNCELLE</strong>
            ...
            <table class="auto-style10">
                <tr>
                    <td class="auto-style11">
                        <asp:Label ID="lblKategoriAd" runat="server" Text="Kategori Ad :"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="tboxKategoriAd" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style11">
                    ...
                    <td>
                        <asp:DropDownList ID="ddListCinsiyet" runat="server" Width="120px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
