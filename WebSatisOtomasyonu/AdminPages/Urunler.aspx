<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/users.Master" AutoEventWireup="true" CodeBehind="Urunler.aspx.cs" Inherits="WebSatisOtomasyonu.UserPage.Urunler" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="100%">
        <div style="width: 1300px; margin: auto; height: 25px; background-color: #808080; border-radius: 20px;">
            <table class="auto-style6">
                <tr>
                    ...
                    <td class="auto-style56" style="border-right-style: solid; border-right-width: thin; border-right-color: #FFFFFF"><strong>Adet Ekle</strong></td>
                    <td class="auto-style49" style="border-right-style: solid; border-right-width: thin; border-right-color: #FFFFFF"><strong>Güncelle</strong></td>
                    <td class="auto-style66"><strong>Sil</strong></td>
                </tr>
            </table>
        </div>
                    ...
                    <table class="auto-style45">
                        <tr>
                            ...
                            <td class="auto-style55" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF">
                                <asp:Label ID="lblAdet" runat="server" CssClass="auto-style46" Text='<%# Eval("urun_adet") %>'></asp:Label>
                            </td>
                            ...
                            <td class="auto-style47" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF">
                                <a href="UrunGuncelleDetay.aspx?urunid=<%#Eval("urun_id")%>">
                                    <asp:Image ID="imgEdit" runat="server" Height="16px" ImageUrl="~/pics/edit.png" Width="16px" />
                                </a>
                            </td>
                            <td class="auto-style67" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF">
                                <a href="Urunler.aspx?urunid=<%#Eval("urun_id")%>&islem=sil">
                                    <asp:Image ID="imgDelete" runat="server" Height="16px" ImageUrl="~/pics/delete.png" Width="16px" />
                                </a>
                            </td>
                        </tr>
                    </table>
        ...
        <div style="margin-left: 50px; background-color: #808080; border-radius: 20px;" class="auto-style74">
            <table class="auto-style45">
                <tr>
                    <td class="auto-style68" style="border-right-style: solid; border-right-width: thin; border-right-color: #FFFFFF; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF;">&nbsp;</td>
                    <td class="auto-style73" style="border-right-style: solid; border-right-width: thin; border-right-color: #FFFFFF; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF;" ><strong>Ürün Adet</strong></td>
                    <td class="auto-style73" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF;border-right-style: solid; border-left-style: solid; border-left-width: thin; border-right-width: thin; border-right-color: #FFFFFF; border-left-color: #FFFFFF"><strong>Alış Fiyatı</strong></td>
                    <td class="auto-style72" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF;border-left-style: solid; border-left-width: thin; border-left-color: #FFFFFF;"><strong>Satış Fiyatı</strong></td>
                </tr>
            </table>
        </div>
        <div style="margin-left: 50px; background-color: #808080; border-radius: 20px;" class="auto-style74">
            <table class="auto-style45">
                <tr>
                    <td class="auto-style68" style="border-right-style: solid; border-right-width: thin; border-right-color: #FFFFFF;"><strong>Toplam :</strong></td>
                    <td class="auto-style73" ><strong>
                        <asp:Label ID="lblToplamAdet" runat="server">0</asp:Label>
                    </strong></td>
                    <td class="auto-style73" style="border-right-style: solid; border-left-style: solid; border-left-width: thin; border-right-width: thin; border-right-color: #FFFFFF; border-left-color: #FFFFFF"><strong>
