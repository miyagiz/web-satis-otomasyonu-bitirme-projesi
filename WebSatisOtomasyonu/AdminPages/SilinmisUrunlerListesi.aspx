<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/users.Master" AutoEventWireup="true" CodeBehind="SilinmisUrunlerListesi.aspx.cs" Inherits="WebSatisOtomasyonu.AdminPages.SilinmisUrunlerListesi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="baslik">
        <strong>SİLİNMİŞ ÜRÜNLERİN BİLGİLERİ</strong>
        ...
        <div style="width: 1300px; margin: auto; height: 25px; background-color: #808080; border-radius: 20px;">
            <table class="auto-style6">
                <tr>
                    ...
                    <td class="auto-style56"><strong>Aktif Hale Getir</strong></td>
                </tr>
            </table>
        </div>
                ...
                <ItemTemplate>
                    <table class="auto-style45">
                        <tr>
                            ...
                            <td class="auto-style57" style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #FFFFFF">
                                <a href="SilinmisUrunlerListesi.aspx?urunid=<%#Eval("urun_id")%>&islem=aktifet">
